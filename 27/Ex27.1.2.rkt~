...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname Example) (read-case-sensitive #t) (teachpacks ((lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.rkt" "teachpack" "htdp")))))
;;*******************************************************************
